...
const FormAddKerusakan = () => {
    ...
    const saveProduct = async(e) =>{
        ...
        try {
            await axios.post(`${url}/kerusakan`, formData,{
                headers:{
        ...
        <div className="columns is-centered mt-5">
            ...
            <h2 value={msg}></h2>
                <form onSubmit={saveProduct}>
                    <div className="field">
                        <label className="label">Title Kerusakan</label>
                        <div className="control">
                            <input 
                                ...
                                placeholder="Title Kerusakan (example : meja rusak)" 
                            />
                        </div>
                    </div>

                    <div className="field mb-3">
                        <label className="label">Description Kerusakan</label>
                        <div className="control">
                            <textarea 
                            ...
                            placeholder="Description Kerusakan (example : meja ini rusak parah, tolong perbaiki meja ini atau diganti)" 
                            >
                            </textarea>
                        </div>
                    </div>
